...
fig.add_trace(
    go.Bar(
        x=top5["country"],
        y=top5["pop"]/1000000,  # Convert to millions
...
df_grouped = df_filtered.groupby(['continent', 'year'], observed=True)['pop'].sum().reset_index()
