...
# Must add a separate trace for the 'Supressed'.
null_mask = ~pd.isna(z)
fig.add_trace(
    go.Choropleth(
        ...
        customdata=merged.loc[null_mask, ["quantile_label", "Value"]],
        hovertext=merged.loc[null_mask, "Area Name"],
        hovertemplate=(
            "<b>%{hovertext}</b><br>"
...
fig.add_trace(
    go.Choropleth(
        ...
        marker_line_width=0.5,
        marker_line_color="white",
        customdata=merged.loc[~null_mask, ["quantile_label"]],
        hovertext=merged.loc[~null_mask, "Area Name"],
        hovertemplate=(
            "<b>%{hovertext}</b><br>"
            "Value: Suppressed<br>"
