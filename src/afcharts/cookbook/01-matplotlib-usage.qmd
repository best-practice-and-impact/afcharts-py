...
#| output: false
import matplotlib.pyplot as plt
from matplotlib.tickers import StrMethodFormatter
# Load gapminder dataset from plotly
from plotly.express.data import gapminder
...
df_grouped = df[df['continent'] != 'Oceania'] \
...
fig = plt.figure()
patches, labels, texts = plt.pie(group_counts.values,
...
# AF package colours
from afcharts.assets.af_colours import focus
...
colours = {country: focus[1 if country == "Brazil" else 0] for country in top5["country"].unique()}
