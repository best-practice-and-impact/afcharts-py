...
The full list of available palettes can be found by running `afcharts_py.assets.af_colours`.

### af_colour_values dictionary
```{python}
import pandas as pd
from afcharts.assets.af_colours import af_colour_values, main, duo, sequential, diverging
